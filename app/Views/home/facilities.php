...
$pageTitle = !empty($data['page']->title) ? $data['page']->title : 'Campus Life & Facilities';
$pageDesc = !empty($data['page']->meta_description) ? $data['page']->meta_description : ('World-class infrastructure, high-tech research laboratories, modern libraries, and athletic arenas at ' . $schoolName . '.');
...
<body>
    ...
    <main class="py-5" style="background: var(--f-bg, #f8fafc);">
        <div class="container">
                        ...
                        <div class="bg-dark text-white p-3 d-flex flex-wrap align-items-center justify-content-between gap-2 border-bottom border-secondary border-opacity-50">
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div>
                                    ...
                                    <span class="badge bg-danger text-uppercase font-monospace" style="font-size: 0.65rem;">Facilities Dossier &bull; Interactive PDF Reader</span>
                                </div>
                            </div>
                            ...
                            <object data="<?php echo $fileUrl; ?>#toolbar=1&navpanes=0&scrollbar=1" type="application/pdf" width="100%" height="100%">
                                <iframe src="<?php echo $fileUrl; ?>" width="100%" height="100%" style="border: none;">
                                    <div class="p-5 text-center text-white">
                                        ...
                                        <p class="fs-5 fw-bold mb-2">Campus Brochure Ready for Reading</p>
            ...
            <?php else: ?>
                <!-- DEFAULT LUXURY FACILITIES CARDS -->
                <div class="row g-4">
                    <div class="col-lg-6">
                        <div class="facility-card-luxury position-relative overflow-hidden rounded-3 shadow-sm border bg-white h-100">
                            <img src="https://images.unsplash.com/photo-1521587760476-6c12a4b040da?q=80&w=800" class="w-100" style="height: 280px; object-fit: cover;" alt="Digital Commons Library">
                            <div class="p-4 bg-white border-top">
                                <h3 class="h5 fw-bold text-dark mb-1">Modern Digital Library &amp; Commons</h3>
                                <p class="text-muted small mb-0">Over 40,000 physical volumes, access to international research databases, and private collaborative study suites.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="facility-card-luxury position-relative overflow-hidden rounded-3 shadow-sm border bg-white h-100">
                            <img src="https://images.unsplash.com/photo-1581092160607-ee22621dd758?q=80&w=800" class="w-100" style="height: 280px; object-fit: cover;" alt="STEAM & Robotics Lab">
                            <div class="p-4 bg-white border-top">
                                <h3 class="h5 fw-bold text-dark mb-1">STEAM &amp; Robotics Research Suite</h3>
                                <p class="text-muted small mb-0">High-speed workstations, 3D additive printing, microcontroller electronics kits, and experimental physics apparatus.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="facility-card-luxury position-relative overflow-hidden rounded-3 shadow-sm border bg-white h-100">
                            <img src="https://images.unsplash.com/photo-1534438327276-14e5300c3a48?q=80&w=800" class="w-100" style="height: 280px; object-fit: cover;" alt="Athletics & Aquatic Complex">
                            <div class="p-4 bg-white border-top">
                                <h3 class="h5 fw-bold text-dark mb-1">Athletics &amp; Aquatic Complex</h3>
                                <p class="text-muted small mb-0">Olympic-standard 25m indoor swimming pool, FIFA-grade synthetic soccer pitch, and multi-court basketball arena.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="facility-card-luxury position-relative overflow-hidden rounded-3 shadow-sm border bg-white h-100">
                            <img src="https://images.unsplash.com/photo-1514525253161-7a46d19cd819?q=80&w=800" class="w-100" style="height: 280px; object-fit: cover;" alt="Performing Arts Center">
                            <div class="p-4 bg-white border-top">
                                <h3 class="h5 fw-bold text-dark mb-1">Performing Arts Center &amp; Theater</h3>
                                <p class="text-muted small mb-0">Acoustically tuned 650-seat theater hosting international guest speakers, symphonic recitals, and dramatic productions.</p>
                            </div>
                        </div>
                    </div>
                </div>
